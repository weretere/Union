...
public class MyNetworkServer1 : MonoBehaviour {
	...
	private void RecieveData()
	{
		...
		while (true){
			try {
				...
				string _ip = "IP Address of Server: " + anyIP.ToString ();
				string clientStr = " // Client: " + client.ToString();

				string appendText = _ip + clientStr;
